...
coordinator_agent = Team(
    ...
    instructions=[
        ...
        "Ask the content analysis agent to analyze the transcript given by voice analysis agent for rhetorical structure, persuasion, tone, clarity, and filler words.", 
